...
<VirtualHost *:443>
        ...
        SSLEngine on
        ErrorLog /var/log/apache2/cal.jeroenvd.nl/ssl_error_log
        TransferLog /var/log/apache2/cal.jeroenvd.nl/ssl_access_log
        CustomLog /var/log/apache2/cal.jeroenvd.nl/ssl_request_log "%t %h %{SSL_PROTOCOL}x %{SSL_CIPHER}x \"%r\" %b"
        LogLevel warn
